...
//  HED-CoreML
//
//  Created by Yeji Chun on 2020/01/28.
...
class HED {
    ...
    let hedSO = HED_so()
    let hedSO3 = HED_so3()
    let edge = EdgeDetectorModel()

    
    var selectedModel: SelectedModel = .dsn3
...
func doInference(inputImage: UIImage) -> UIImage {
        ...
        featureProvider = try! edge.prediction(data: inputPixelBuffer)
